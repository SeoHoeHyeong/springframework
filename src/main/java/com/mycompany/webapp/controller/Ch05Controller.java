...
public class Ch05Controller {
	...
	public String createCookie(HttpServletResponse response) {
		...
		Cookie cookie = new Cookie("useremail" , "shh4190@naver.com");
		cookie.setDomain("localhost"); // localhost로
	...
	public String createJsonCookie(HttpServletResponse response) {
		logger.info("실행");
		
		//String json = "{\"userid\":\"fail\", \"useremail\":\"fail@company.com\",\"tel\":\"0101231234\"}";

...
<div class="card m-2">
	...
	<div class="card-body">
		...
		<div class="card">
			...
			<div class="card-body">
				<a href="objectSaveAndRead1" color = "blue" class="btn btn-info btn-sm">객체를 저장하고 읽기</a>
		...
		<div class="card">
			...
			<div class="card-body">
				<a href="useJstl1" color = "blue" class="btn btn-info btn-sm">Jstl 사용하기</a>
				<a href="useJstl2" color = "blue" class="btn btn-info btn-sm">Jstl 사용하기</a>
			</div>
		</div>
		...
		<div class="card">
			...
			<div class="card-body">
				<a href="useModelAttribute1" color = "blue" class="btn btn-info btn-sm">@ModelAttribute로 전달</a>
				<a href="useModelAttribute2" color = "blue" class="btn btn-info btn-sm">@ModelAttribute로 사용</a>
			</div>
		</div>

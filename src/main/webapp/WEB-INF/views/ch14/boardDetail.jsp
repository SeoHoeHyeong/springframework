      ...
      <div>
         <div>
            <div>
               ...
               <span>제목:</span> <span>${board.btitle}</span> <br /> 
               <span>글쓴이:</span> <span>${board.mid}</span> <br /> 
               <span class="title">날짜:</span> <span><fmt:formatDate value="${board.bdate}" pattern="yyyy-MM-dd HH.mm.ss" /></span> <br />
            </div>
            ...
            <a class="btn btn-info btn-sm mt-2" href="boardList">목록보기</a>
